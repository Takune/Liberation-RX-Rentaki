...
light_vehicles = [
    ...
    // UAZ / Ural / trucks
	["CUP_O_UAZ_Unarmed_RU",2,100,2,GRLIB_perm_log],
	["CUP_O_UAZ_MG_RU",3,250,3,GRLIB_perm_log],
	["CUP_O_UAZ_AGS30_RU",4,400,4,GRLIB_perm_log],
    ["CUP_O_UAZ_AA_RU",1,250,5,GRLIB_perm_log],
    ["CUP_O_UAZ_SPG9_RU",1,180,5,GRLIB_perm_inf],
    ["CUP_O_UAZ_METIS_RU",1,250,5,GRLIB_perm_log],
	["CUP_O_Ural_RU",3,200,3,GRLIB_perm_log],
	["CUP_O_Ural_Open_RU",3,200,3,GRLIB_perm_log],
	["CUP_O_Ural_Repair_RU",5,500,5,GRLIB_perm_log],
	["CUP_O_Ural_Reammo_RU",5,700,5,GRLIB_perm_log],
	["CUP_O_Ural_Refuel_RU",5,700,5,GRLIB_perm_log],

	// GAZ Tigr / modern RU
	["CUP_O_Tigr_233011_GREEN_RU",5,500,5,GRLIB_perm_log],
	["CUP_O_Tigr_233014_GREEN_RU",5,700,5,GRLIB_perm_log],
	["CUP_O_Tigr_233014_GREEN_PK_RU",8,1000,8,GRLIB_perm_inf],
	["CUP_O_Tigr_M_233114_GREEN_RU",5,800,5,GRLIB_perm_log],
	["CUP_O_Tigr_M_233114_GREEN_PK_RU",8,1200,8,GRLIB_perm_inf],
	["CUP_O_Tigr_M_233114_GREEN_KORD_RU",10,1500,10,GRLIB_perm_inf]
];
...
heavy_vehicles = [
	...
	["CUP_O_BMP3_RU",10,800,10,GRLIB_perm_inf],

	["CUP_O_BRDM2_RUS",10,1000,10,GRLIB_perm_inf],
	["CUP_O_BRDM2_ATGM_RUS",10,1250,10,GRLIB_perm_inf],

	["CUP_O_MTLB_pk_WDL_RU",10,1250,10,GRLIB_perm_inf],

	["CUP_O_BTR80_CAMO_RU",15,1200,15,GRLIB_perm_tank],
	["CUP_O_BTR80A_CAMO_RU",15,1500,15,GRLIB_perm_tank],
	["CUP_O_BTR90_RU",15,2500,15,GRLIB_perm_tank],
	["CUP_O_BTR90_HQ_RU",15,2500,15,GRLIB_perm_tank],
    ...
    // CUP older Soviet / Russian tanks
	["CUP_O_T55_CHDKZ",10,1800,10,GRLIB_perm_inf],
	["CUP_O_T55_TK",10,1800,10,GRLIB_perm_inf],

	// Tanks
	["CUP_O_T72_RU",15,3500,15,GRLIB_perm_tank],
	["CUP_O_T90_RU",15,4500,15,GRLIB_perm_tank],

	// Modern tanks / T-90M Proryv-3
	["CUP_O_T90M_RU",20,6000,25,GRLIB_perm_air],
	["CUP_O_T90M_CAMO_RU",20,6000,25,GRLIB_perm_air],
	["CUP_O_T90M_DESERT_RU",20,6000,25,GRLIB_perm_air],
    // 2035 / Angara
	["O_MBT_04_cannon_F",20,4500,25,GRLIB_perm_air],
	["O_MBT_04_command_F",20,7000,30,GRLIB_perm_air]

];

air_vehicles = [
	["O_UAV_01_F",0,10,0,GRLIB_perm_log],
	["O_UAV_06_F",0,30,0,GRLIB_perm_log],
	["O_UAV_02_dynamicLoadout_F",5,1000,5,GRLIB_perm_log],

	// Transport helicopters
	["CUP_O_Mi8_RU",1,350,5,GRLIB_perm_log],
	["CUP_O_Mi8AMT_RU",3,1300,10,GRLIB_perm_inf],
	["CUP_O_MI6T_RU",3,1500,10,GRLIB_perm_inf],
	["CUP_O_Ka60_Grey_RU",20,600,40,GRLIB_perm_air],

	// Attack helicopters
	["CUP_O_Mi24_V_RU",20,2800,40,GRLIB_perm_tank],
	["CUP_O_Mi24_D_RU",20,2800,40,GRLIB_perm_tank],
	["CUP_O_Mi24_V_Dynamic_RU",20,3000,40,GRLIB_perm_tank],
	["CUP_O_Mi24_D_Dynamic_RU",20,3000,40,GRLIB_perm_tank],

	["CUP_O_Ka50_RU",10,1800,20,GRLIB_perm_tank],
	["CUP_O_Ka50_DL_RU",10,1850,20,GRLIB_perm_tank],
	["CUP_O_Ka52_RU",10,2500,20,GRLIB_perm_tank],

	// Fixed wing
	["CUP_O_Su25_RU",20,3600,40,GRLIB_perm_air],
	["CUP_O_Su25_Dyn_RU",20,3800,40,GRLIB_perm_air],
	["CUP_O_SU34_RU",20,4200,40,GRLIB_perm_air]
];
